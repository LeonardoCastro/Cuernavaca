...
Speeds_Transition = Array(S, Lanes, J)
Densities_Transition = Array(S, Lanes, J)

Fluxes_Transition1 = zeros(S, Lanes, J)
Fluxes_Transition2 = zeros(S, Lanes, J)

D_Speeds_Transition = Array(S, Lanes, J)
D_Densities_Transition = Array(S, Lanes, J)

D_Fluxes_Transition1 = zeros(S, Lanes, J)
D_Fluxes_Transition2 = zeros(S, Lanes, J)

jldopen("S1-ConDatos-CR.jld", "w") do file
